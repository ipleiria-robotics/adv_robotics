...
3. Após reiniciar o PC, abra a loja do Windows (Microsoft Store), aceda ao [Ubuntu 24.04.x](https://apps.microsoft.com/detail/9NZ3KLHXDJP5) e obtenha/instale a aplicação (esta é a distribuição de Linux que será utilizada);
