...
#
# Modifications copyright (c) 2021 Hugo Costelha
...
def generate_launch_description():
    ...
    # Create the launch description and populate it after each command
    # declaration
    ...
    # Wether or not for the managed nodes to start automatically
    ...
    # Simulator-related
    # Wether or not to use the simulator
    ...
    declare_world_file_cmd = DeclareLaunchArgument(
        'world_file',
        default_value=os.path.join(worlds_pkg_dir, 'stage-worlds',
                                   'map_laser.world'),
    ...
    start_stage_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(launch_dir, 'stage_sim_launch.py')),
        condition=IfCondition(use_simulator),
        launch_arguments={'namespace': namespace,
                          'use_static_map_odom_tf': use_static_map_odom_tf,
                          'world_file': world_file}.items())
    ...
    # Localizaton/Navigation launch file
