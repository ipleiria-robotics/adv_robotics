...
sudo apt -y install python3-pip python3-empy python3-flake8 python3-pep8 python3-numpy python3-opencv python3-matplotlib python3-scipy python3-argcomplete python3-skimage python3-ruamel.yaml
